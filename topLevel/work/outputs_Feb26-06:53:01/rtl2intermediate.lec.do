...
# Generated on: Sun Feb 26 07:17:38 IST 2023 (Sun Feb 26 01:47:38 GMT 2023)

set lec_version [regsub {(-).} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file logs_Feb26-06:53:01/rtl2intermediate.lec.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/booth32x32_top -revised fv_map
...
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k ../rtl/topMod.v ../rtl/cla.v ../rtl/multi_f.v ../rtl/test03.v
elaborate_design -golden -root {booth32x32_top} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/booth32x32_top/fv_map.v.gz
