...
# Generated on: Wed Mar 01 01:11:03 IST 2023 (Tue Feb 28 19:41:03 GMT 2023)

set lec_version [regsub {(-).} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file logs_Mar01-01:10:51/intermediate2final.lec.log -replace

usage -auto -elapse

set_verification_information fv_map_booth_multiplier_top_mv_db

read_implementation_information fv/booth_multiplier_top -golden fv_map -revised booth_multiplier_top_mv
...
read_library -liberty -both   /home/sgeuser114/Desktop/venkat/singleCycleProcessor/topLevel/work/../lib/fast.lib /home/sgeuser114/Desktop/venkat/singleCycleProcessor/topLevel/work/../lib/slow.lib

read_design -verilog95   -golden -lastmod -noelab fv/booth_multiplier_top/fv_map.v.gz
elaborate_design -golden -root {booth_multiplier_top}

read_design -verilog95   -revised -lastmod -noelab outputs_Mar01-01:10:51/booth_multiplier_top_m.v
elaborate_design -revised -root {booth_multiplier_top}
