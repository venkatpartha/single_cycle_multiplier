...
# Generated on: Wed Mar 01 01:11:01 IST 2023 (Tue Feb 28 19:41:01 GMT 2023)

set lec_version [regsub {(-).} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file logs_Mar01-01:10:51/rtl2intermediate.lec.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/booth_multiplier_top -revised fv_map
...
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k ../rtl/topLevel_2.v ../rtl/cla.v ../rtl/multi_f.v ../rtl/test03.v
elaborate_design -golden -root {booth_multiplier_top} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/booth_multiplier_top/fv_map.v.gz
