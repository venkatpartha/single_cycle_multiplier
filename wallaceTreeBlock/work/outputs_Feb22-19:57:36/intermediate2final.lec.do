...
# Generated on: Wed Feb 22 19:58:44 IST 2023 (Wed Feb 22 14:28:44 GMT 2023)

set lec_version [regsub {(-).} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file logs_Feb22-19:57:36/intermediate2final.lec.log -replace
...
read_design -verilog95   -revised -lastmod -noelab outputs_Feb22-19:57:36/pp_tree16x64_m.v
