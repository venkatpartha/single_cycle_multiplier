...
# Generated on: Thu Feb 16 01:09:43 IST 2023 (Wed Feb 15 19:39:43 GMT 2023)

set lec_version [regsub {(-).} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file logs_Feb16-00:45:13/intermediate2final.lec.log -replace
...
read_design -verilog95   -revised -lastmod -noelab outputs_Feb16-00:45:13/pp_tree16x64_m.v
