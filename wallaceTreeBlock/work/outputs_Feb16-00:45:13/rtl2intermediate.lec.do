...
# Generated on: Thu Feb 16 00:51:36 IST 2023 (Wed Feb 15 19:21:36 GMT 2023)

set lec_version [regsub {(-).} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file logs_Feb16-00:45:13/rtl2intermediate.lec.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/pp_tree16x64 -revised fv_map
...
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k ../rtl/test00.v
elaborate_design -golden -root {pp_tree16x64} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/pp_tree16x64/fv_map.v.gz
