...
# Generated on: Sun Feb 26 07:22:28 IST 2023 (Sun Feb 26 01:52:28 GMT 2023)

set lec_version [regsub {(-).} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file logs_Feb26-07:19:37/rtl2intermediate.lec.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/booth16x16_top -revised fv_map
...
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k ../rtl/cla.v ../rtl/pp_8_Gen.v ../rtl/topMod_02.v ../rtl/wallaceTree_8PP.v
elaborate_design -golden -root {booth16x16_top} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/booth16x16_top/fv_map.v.gz
...
#add_name_alias fv/booth16x16_top/fv_map.singlebit.original_name.alias.json.gz -revised
