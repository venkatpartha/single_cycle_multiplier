...
# Generated on: Sun Feb 26 07:22:37 IST 2023 (Sun Feb 26 01:52:37 GMT 2023)

set lec_version [regsub {(-).} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file logs_Feb26-07:19:37/intermediate2final.lec.log -replace

usage -auto -elapse

set_verification_information fv_map_booth16x16_top_mv_db

read_implementation_information fv/booth16x16_top -golden fv_map -revised booth16x16_top_mv
...
read_library -liberty -both   /home/sgeuser114/Desktop/venkat/singleCycleProcessor/multi_16x16/work/../lib/fast.lib /home/sgeuser114/Desktop/venkat/singleCycleProcessor/multi_16x16/work/../lib/slow.lib /home/sgeuser114/Desktop/venkat/singleCycleProcessor/multi_16x16/work/../lib/fast.lib /home/sgeuser114/Desktop/venkat/singleCycleProcessor/multi_16x16/work/../lib/slow.lib

read_design -verilog95   -golden -lastmod -noelab fv/booth16x16_top/fv_map.v.gz
elaborate_design -golden -root {booth16x16_top}

read_design -verilog95   -revised -lastmod -noelab outputs_Feb26-07:19:37/booth16x16_top_m.v
elaborate_design -revised -root {booth16x16_top}

#add_name_alias fv/booth16x16_top/fv_map.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/booth16x16_top/booth16x16_top_mv.singlebit.original_name.alias.json.gz -revised
